...
PDFView.webViewerLoad = function() {
  ...
  var page_rotate_ccw = document.getElementById('page_rotate_ccw');
  if(page_rotate_ccw) {
    page_rotate_ccw.addEventListener('click', function() {
        PDFView.rotatePages(-90);
    });
  }

  var page_rotate_cw = document.getElementById('page_rotate_cw');
  if(page_rotate_cw) {
    page_rotate_cw.addEventListener('click', function() {
      PDFView.rotatePages(90);
    });
  }
